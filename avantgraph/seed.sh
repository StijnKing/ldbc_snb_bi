...
docker run -it --rm -v ./data:/data -v ./scripts:/scripts --cap-add SYS_ADMIN --cap-add SYS_PTRACE --privileged --name avantgraph ${AG_IMAGE} /scripts/create-graph-schema.sh
