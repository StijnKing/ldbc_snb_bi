...
ag-schema create-vertex-table $GRAPH_FILE --vertex-label=Post --vertex-label=Message --vertex-property=id=CHAR_STRING --vertex-property=imageFile=CHAR_STRING --vertex-property=locationIP=CHAR_STRING --vertex-property=browserUsed=CHAR_STRING --vertex-property=content=CHAR_STRING --vertex-property=length=S64 --add-reification
